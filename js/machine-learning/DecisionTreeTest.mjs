...
function testDecisionTreeLearner() {
  ...
  console.assert(
    dtl.call([5, 3, 1, 0.1]) === "setosa",
    "Failed to classify setosa."
  );
  console.assert(
    dtl.call([6, 5, 3, 1.5]) === "versicolor",
    "Failed to classify versicolor."
  );
  console.assert(
    dtl.call([7.5, 4, 6, 2]) === "virginica",
    "Failed to classify virginica."
  );
}
